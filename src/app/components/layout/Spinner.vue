<template>
  <section
    class="spinner"
    :class="small ? 'spinner--small' : large ? 'spinner--large' : ''"
  >
    <div class="spinner__container">
      <b-icon class="spinner__ball" icon="volleyball-ball" pack="fas" />
...
.spinner__ball {
  ...
  transform: translate(-50%, -50%);
  overflow: hidden;
  animation: ball 1.3s cubic-bezier(0.12, 0, 0.87, 1) infinite;
...
.spinner__shadow {
  ...
  filter: blur(2px);
  z-index: -1;
  animation: shadow 1.3s cubic-bezier(0.12, 0, 0.87, 1) infinite;
}
...
.spinner--small {
  ...
  .spinner__ball {
    animation: ball-small 1.3s cubic-bezier(0.12, 0, 0.87, 1) infinite;
    width: ($ball-size / 2);
    height: ($ball-size / 2);
  }
...
.spinner--large {
  ...
  .spinner__ball {
    animation: ball-large 1.3s cubic-bezier(0.12, 0, 0.87, 1) infinite;
    width: ($ball-size * 2);
    height: ($ball-size * 2);
  }
